...
//                .map(roomReservation -> roomReservation.getRoomNo())
//                .noneMatch(reservation -> reservationService.existReservationBetween((Reservation) reservation,checkIn,checkOut));
//    }
